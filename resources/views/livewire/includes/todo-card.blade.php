    ...
    <div class="flex justify-between space-x-2">
        <div class="flex">
            @if($todo->completed)
                ...
                <input wire:click="toggle toggle( {{$todo->id}} )" class="mr-2" type="checkbox" checked> 
            @else
        ...
        <div class="flex items-center space-x-2">
            ...
            <button wire:click="delete( {{ $todo->id }} )" wire:confirm="Are you sure you want to delete?" class="text-sm text-red-500 font-semibold rounded hover:text-teal-800 mr-1">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="w-4 h-4">
                    <path stroke-linecap="round" stroke-linejoin="round"
